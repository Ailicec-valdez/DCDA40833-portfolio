...
Getting Started
New to this template? See EDITING_GUIDE.md for a complete walkthrough of the editing workflow.

Template Workflow
Click "Use this template" button (green button at top of repository)
Name your repository (e.g., dcda-skills-portfolio)
Make it Public (required for GitHub Pages)
Clone with GitHub Desktop and open in VS Code
Edit index.html following the TODO markers
Add new pages for each lab assignment
...
Click Save
Wait 1-2 minutes, then visit: https://YOUR-USERNAME.github.io/your-repo-name
Troubleshooting:
...
GitHub Desktop (Git GUI): desktop.github.com
Tableau Public: public.tableau.com
Support
Getting Help
Check EDITING_GUIDE.md - Workflow guide with troubleshooting
Review lab materials - Revisit instructions from Labs 1-6
Test in browser - Open Developer Tools (F12) to see errors
Office hours - Bring specific questions or errors
D2L discussion - Post screenshots of issues
Common Questions
Q: Do I need to know CSS to use this template? A: No! The CSS is complete. You only need to edit HTML content.

Q: What if I want a different color scheme? A: Edit the :root section in css/styles.css (see Customization section above).
...
Credits
Template created for: DCDA 40833 | TCU Spring 2026
